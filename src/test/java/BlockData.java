    ...
    public static void createFaceVertices(ArrayList<Byte> vertices, Block block, Block.Faces face) {
        ...
        switch (face) {
            case Block.Faces.FRONT:
                vertex.add((byte) (-0.5+block.getPosition().x)); vertex.add((byte)(-0.5f+block.getPosition().y)); vertex.add((byte)(-0.5f+block.getPosition().z));       vertex.add((byte)1); vertex.add((byte)0);      vertex.add((byte)0); vertex.add((byte)0); vertex.add((byte)0); vertex.add((byte)getTextureIndex(0, block));
