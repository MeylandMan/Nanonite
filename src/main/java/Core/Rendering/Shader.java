...
public class Shader {
    ...
    public void CreateShader(String vertexFile, String fragmentFile) {
        ...
        int vertexShaderId = loadShader(Client.assetsPath + "shaders/" + vertexFile, GL_VERTEX_SHADER);
        int fragmentShaderId = loadShader(Client.assetsPath + "shaders/" + fragmentFile, GL_FRAGMENT_SHADER);
    ...
    public void Uniform4dv(String name, double[] x) {
        int location = getUniform(name);
        glUniform4dv(location, x);
    }
