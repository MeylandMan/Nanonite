...
import Mycraft.Rendering.Scene;
...
public class Input {
    ...
    // Keys
    public static final InputState[] Debug_Keys = {
            InputState.NOTHING,
            InputState.NOTHING,
            InputState.NOTHING,
            InputState.NOTHING,
    ...
    public static final int DEBUG_WIREFRAME = 10;
    public static final int DEBUG_AMBIENT = 11;
