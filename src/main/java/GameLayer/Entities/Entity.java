package GameLayer.Entities;

import Mycraft.Core.Client;
import Mycraft.Models.Element;
import Mycraft.Models.EntityModel;
import Mycraft.Physics.CharacterBody;
import Mycraft.Physics.Raycast;
...
public class Entity {
    ...
    public void setModel(String modelName) {
        ...
        setTexture(getModel().getTexture());
    }
